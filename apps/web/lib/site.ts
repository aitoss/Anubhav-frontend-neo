// Ported from master's index.html so the metadata stays identical to what the
// Vite build shipped.
export const SITE_URL =
    process.env.NEXT_PUBLIC_SITE_URL?.replace(/\/$/, "") ?? "https://anubhav.ossclub.in"

export const SITE_NAME = "Anubhav"
